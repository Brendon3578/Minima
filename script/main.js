...
navLinks.forEach(a => {
    a.addEventListener("click", () => {
        navLinks.forEach(aNotActive => aNotActive.parentElement.classList.remove("active"))
...
// SMOOTH SCROLL JS
const allScrollElements = document.querySelectorAll(".nav a, .header a.btn.contact, .about-us a")
...
scrollReveal.reveal(
    ...
    {interval: 100, origin: 'bottom', beforeReveal: () => {
        storyNumbers.forEach(numberElement => countUpAnimation(numberElement, 2500));
    }}
